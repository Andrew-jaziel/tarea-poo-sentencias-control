...
public class While extends javax.swing.JInternalFrame {
 ...
 Class ope = new Class();
    ...
    private void bVerificar3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar3ActionPerformed
          boolean n;
        if(!(n=true)){
            JOptionPane.showMessageDialog(null, "El numero perfecto es: "+n);
        } else {
...
// TODO add your handling code here:
    ...
    private void bContar4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bContar4ActionPerformed
        int calificaciones=Integer.parseInt(tfCali4.getText());
       if(calificaciones<0){
             JOptionPane.showMessageDialog(null, "Usted ha digitado -1");
         }
         if (calificaciones<60){
        JOptionPane.showMessageDialog(null, "la calificacion es: reprobada "+calificaciones);
        }else if(calificaciones>=60){
               JOptionPane.showMessageDialog(null, "es aprobado"+calificaciones);
                }
    ...
    private void bCalcular1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular1ActionPerformed
       /** int contador=0;
        String palabra;
        palabra = txt_palabra.getText().toUpperCase().trim();
        for (int x=0; x<palabra.length(); x++){
        if(palabra.charAt(x)!="I"&&"O"!=palabra.charAt(x)&&palabra.charAt(x)!="E"&&palabra.charAt(x)!="U" &&"A"!=palabra.charAt(x)){
        } else {
            contador++;
            }
        }
        lbl_Respuesta.setText(""+contador);
// TODO add your handling code here:*/
    ...
    private void bPagar5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPagar5ActionPerformed
       int cuota=Integer.parseInt(tfCuota5.getText());
       int cuenta=1000;
        int suma;
        
suma=cuenta-cuota;
JOptionPane.showMessageDialog(null, "La cuota es de: "+suma);// TODO add your handling code here:
