...
int n,prom;
        ...
        public void datosAB(){
        a=Integer.parseInt(tfNum2.getText());
        b=Integer.parseInt(tfNum3.getText());
        }
        public void verificarComp(){
        numero=Integer.parseInt(tfNum4.getText());
        }
        public void verificarPass(){
        cadena=tfContra5.getText();
        }
    public Do() {
        initComponents();
    }
    ...
    private void bVerificar3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar3ActionPerformed
        verificarComp();
        boolean verificar;
        verificar= ope.verificarComp(numero);
       if(verificar=true){
           JOptionPane.showMessageDialog(null,"Es compatible");
       } else {
...
// TODO add your handling code here:
    ...
    private void bVerificar4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar4ActionPerformed
      verificarPass();
          ...
          pass= ope.verificarContraseña(cadena);
          if(pass=true){
    ...
    private void bCalcular1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular1ActionPerformed
        ...
        datosIngresados();
        int promedi;
         promedi = ope.sacarPromedio(n,prom);
     JOptionPane.showMessageDialog(null, "El promedio es de: "+promedi);
    ...
    private void bCalcular2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular2ActionPerformed
       datosAB();
       int promedio;
       promedio= ope.sacaPromedioab(a, b);
      JOptionPane.showMessageDialog(null,"El promedio entre a y b es: "+promedio);
